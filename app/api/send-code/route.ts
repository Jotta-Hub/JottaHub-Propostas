          ...
          <body style="background:#08070B;color:#F4F4F6;font-family:'Helvetica Neue',sans-serif;margin:0;padding:0;">
            <div style="max-width:480px;margin:40px auto;padding:0 20px;">
              <div style="margin-bottom:32px;">
                ...
                <span style="display:inline-block;width:0;height:0;border-left:7px solid transparent;border-right:7px solid transparent;border-bottom:11px solid #F4F4F6;margin:0 2px;position:relative;top:-2px;"></span>
                <span style="width:5px;height:5px;background:#8636F2;border-radius:50%;display:inline-block;position:relative;top:-1px;margin-left:2px;"></span>
              </div>
              <div style="background:#111;border:1px solid #1C1C1C;border-radius:4px;overflow:hidden;">
                <div style="background:#8636F2;padding:3px 0;"></div>
                <div style="padding:32px;">
                  ...
                  <p style="font-size:0.95rem;color:rgba(244,244,246,0.7);line-height:1.7;margin-bottom:32px;">Use o código abaixo para confirmar sua assinatura na proposta da JOTTA HUB. O código é válido por <strong style="color:#F4F4F6;">10 minutos</strong>.</p>
                  <div style="background:#08070B;border:1px solid #2E2E2E;border-radius:3px;padding:24px;text-align:center;margin-bottom:32px;">
                    <span style="font-size:3rem;font-weight:900;letter-spacing:0.3em;color:#F4F4F6;">${code}</span>
                  </div>
